                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto ">
                            ...
                            <li className="nav-item me-2">
                                <NavLink className="nav-link" id="navManagerApplicationQueue" to={"/eile"}>Registracijų prašymai</NavLink>
                            </li>

                            <li className="nav-item me-2">
                                <NavLink className="nav-link" id="navManagerCompensationQueue" to={"/kompensacijos"}>Kompensacijų prašymai</NavLink>
                            </li>

                            <li className="nav-item me-2">
                                <NavLink className="nav-link" id="navManagerApplicationStats" to={"/statistika"}>Registracijų statistika</NavLink>
                            </li>
