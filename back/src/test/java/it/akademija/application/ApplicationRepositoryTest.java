...
public class ApplicationRepositoryTest {
	...
	Kindergarten first = kindergartenDAO.save(
		new Kindergarten("123456789", "Pavadinimas 1", "Adresas 2", "Seniunija", 12, 12));
	Kindergarten second = kindergartenDAO.save(
		new Kindergarten("146325698", "Pavadinimas 2", "Adresas 3", "Seniunija", 12, 12));
	Kindergarten third = kindergartenDAO.save(
		new Kindergarten("369258147", "Pavadinimas 3", "Adresas 4", "Seniunija", 12, 12));
	...
	Kindergarten first2 = kindergartenDAO.save(
		new Kindergarten("123456789", "Pavadinimas 1", "Adresas 2", "Seniunija", 12, 12));
	Kindergarten second2 = kindergartenDAO.save(
		new Kindergarten("146325698", "Pavadinimas 2", "Adresas 3", "Seniunija", 12, 12));
	Kindergarten third2 = kindergartenDAO.save(
		new Kindergarten("369258147", "Pavadinimas 3", "Adresas 4", "Seniunija", 12, 12));
	...
	assertEquals(application1.getChildName(), applicationDAO.findById(application1.getId())
								.get()
								.getChildName());
	assertTrue(application1.getApprovedKindergarten()
			       .getId()
			       .equals("123456789"));
	...
	assertEquals(1, applicationDAO.findAllApplicationsWithStatusSubmitted()
				      .size());
	applicationDAO.deleteById(application1.getId());
	applicationDAO.deleteById(application2.getId());
	assertTrue(applicationDAO.findAll()
				 .isEmpty());
