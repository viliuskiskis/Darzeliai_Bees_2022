...
public class DownloadCertificatesPage extends AbstractObjectPage {
    ...
    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div/div/table/tbody/tr/td[6]/button")
...
//    public Boolean assertThatPrasymuPazymosPageLoaded () {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(3));
//        return wait.until(
//                ExpectedConditions.presenceOfElementLocated(By.id("searchBox")));
//         //       (By.xpath("//*[@id=\"root\"]/div/div/div/div/h6"), "Prašymų registruotis į valstybinius darželius pažymos"));
//        searchBox.click();
//    }
